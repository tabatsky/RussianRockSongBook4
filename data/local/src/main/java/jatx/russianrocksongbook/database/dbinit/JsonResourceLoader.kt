...
internal val artistMap = mapOf(
    ...
    "Dругой Ветер" to R.raw.drugoj_veter,
    "F.P.G." to R.raw.fpg,
    ...
    "Автоматические удовлетворители" to R.raw.avtom,
    ...
    "Екатерина Яшникова" to R.raw.yashnikova,
    "Звери" to R.raw.zveri,
    "Звуки Му" to R.raw.zvukimu,
    ...
    "Любэ" to R.raw.lyube,
    "Ляпис Трубецкой" to R.raw.trubetskoi,
    "Магелланово Облако" to R.raw.magelanovo_oblako,
    "Марко Поло" to R.raw.marko_polo,
    ...
    "Павел Пиковский" to R.raw.pikovskij_pavel_xyugo,
