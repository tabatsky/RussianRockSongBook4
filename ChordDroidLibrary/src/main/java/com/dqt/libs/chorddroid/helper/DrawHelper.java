...
public class DrawHelper {
	...
	private static int colorBg = 0xFFFFFFBB;
	private static int colorMain = 0xFF000000;

	public static void setColors(int colorBg, int colorMain) {
		DrawHelper.colorBg = colorBg;
		DrawHelper.colorMain = colorMain;
	}
	...
	public static void drawFingerPosition(Canvas canvas, int stringNum,
		...
		if (stringNum > 0 && stringNum < 7 && fretNum > -2 && fretNum < 6
			...
			textPaint.setColor(colorMain);

			String drawText = "";
			if (fretNum > 0) {
				if (fingerNum > 0) {
					drawText = String.valueOf(fingerNum);
					textPaint.setColor(colorBg);
				}
			} else if (fretNum == 0) {
				drawText = "o";
			} else if (fretNum == -1) {
	...
	public static void drawBorderBox(Canvas canvas) {
		...
		borderPaint.setColor(colorMain);
