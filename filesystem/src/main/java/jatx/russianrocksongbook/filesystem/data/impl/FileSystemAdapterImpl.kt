package jatx.russianrocksongbook.filesystem.data.impl
...
@Singleton
@BoundTo(supertype = jatx.russianrocksongbook.filesystem.data.FileSystemAdapter::class, component = SingletonComponent::class)
class FileSystemAdapterImpl @Inject constructor(
    @ApplicationContext val context: Context
): jatx.russianrocksongbook.filesystem.data.FileSystemAdapter {
